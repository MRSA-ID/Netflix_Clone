  ...
  return (
    <>
      <div className="container max-w-full bg-hero-pattern h-screen bg-no-repeat bg-auto flex flex-col justify-center items-center border-b-8 border-gray-800">
        <div className="container max-w-full h-8 lg:h-10 m-auto">
            <div className="px-5 lg:px-12 flex items-center justify-between w-full h-full">
              <span className="inline-block h-40 w-40 ">
                ...
                <div className="flex w-auto h-full text-white">
                  ...
                  <button className="ml-2 lg:ml-12 px-2 lg:px-4 text-lg font-thin bg-red-650 text-white rounded-md ">
                    <span>Signin</span>
                  </button>
                </div>
            </div>
        </div>
        <div className="container text-white h-auto text-center flex flex-col py-10 px-14 lg:px-36 lg:py-2 items-center ">
          <div className="container max-w-3xl flex flex-col items-center justify-center px-0 mb-20 lg:mt-10">
            <div className="pb-3 lg:pb-6">
              <h1 className="text-4xl lg:text-6xl font-bold">Unlimited movies, TV shows, and more.</h1>
              <h2 className="text-xl lg:text-3xl font-semibold pt-8">Watch anywhere. Cancel anytime.</h2>
            </div>
            <form className="container pt-2">
              <h3 className="text-xl font-semibold pb-10">Ready to watch? Enter your email to create or restart your membership.</h3>
              <div className="px-0 h-16 flex flex-col lg:flex-row justify-center items-center lg:justify-start lg:items-start gap-5 lg:gap-0 mt-6">
                <input className="p-4 w-full border border-gray-300 focus:outline-none text-black text-xl lg:h-full" placeholder="Email address"/>
                <button className="w-2/5 bg-red-650 flex justify-center items-center lg:border-l-2 lg:border-gray-700 hover:bg-red-500  lg:px-4 py-2 rounded-sm lg:h-full">
                  <span className="lg:text-3xl whitespace-nowrap lg:whitespace-normal font-normal">Get Started</span>
                  <span className="pl-1 pt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 lg:h-7 lg:w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
